...
let current_users :string[] = ['ZoYa' , 'ZaiNab' , 'ZiMal' , 'Zehra' , 'Zara'] ; 

let new_users :string[] = ['SuMaira' , 'SaRa' , 'ZiMal' , 'ZoYa' , 'Saba' ] ; 
...
new_users.forEach(newUserName =>  {
    ...
    else{console.log(` The User name ${newUserName} is availble`)
